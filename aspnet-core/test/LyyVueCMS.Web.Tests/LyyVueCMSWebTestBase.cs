...
{
    public abstract class LyyVueCMSWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static LyyVueCMSWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(LyyVueCMSWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<LyyVueCMSDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<LyyVueCMSDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<LyyVueCMSDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<LyyVueCMSDbContext, Task<T>> func)
        {
            T result;
