(function ($) {
        ...
        columnDefs: [
            ...
            },
            {
                ...
                render: (data, type, row, meta) => {
                    return [
                        `   <button type="button" class="btn btn-sm bg-secondary edit-user" data-user-id="${row.id}" data-toggle="modal" data-target="#SiteEditModal">`,
    ...
    $(document).on('click', 'a[data-target="#SiteCreateModal"]', (e) => {
        console.log(e);
