...
namespace LyyCMS.Migrations
{
    ...
    [Migration("20230719092924_sysmanege")]
    partial class sysmanege
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LyyCMS.Regions.Region", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasMaxLength(300)
            ...
            modelBuilder.Entity("LyyCMS.SysManage.SysDict", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("LyyCMS.SysManage.SysDictItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("LyyCMS.Regions.Region", b =>
                {
                    b.HasOne("LyyCMS.Regions.Region", "Parent")
                        .WithMany("Children")
                        .HasForeignKey("ParentId");
            ...
            modelBuilder.Entity("LyyCMS.SysManage.SysDictItem", b =>
                {
                    b.HasOne("LyyCMS.SysManage.SysDict", "SysDict")
                        .WithMany("SysDictItems")
                        .HasForeignKey("SysDictId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("SysDict");
                });
