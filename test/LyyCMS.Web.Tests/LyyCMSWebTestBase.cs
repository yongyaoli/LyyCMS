...
{
    public abstract class LyyCMSWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static LyyCMSWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(LyyCMSWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<LyyCMSDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<LyyCMSDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<LyyCMSDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<LyyCMSDbContext, Task<T>> func)
        {
            T result;
